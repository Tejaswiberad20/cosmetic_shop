...
if (isset($_POST['submit']))
{
    ...
    $cvv=  $_POST['cvv'];
        ...
        $sql= "INSERT INTO payment(`username`, `card`,`creditcardno`,`cvv`) VALUES ('$username', '$card','$creditcardno','$cvv')";
            $lastid=$id;
         if($con->query($sql))
        {
        ...
        <div class="right-body">
            <form method="POST">
                <h2 clas="text">Enter User Name:</h2>
                    ...
                    <input type="text"name="creditcardno"class="input">
                    <h2 clas="text">CVV:</h2>
                    <input type="text"name="cvv"class="input">
                    <a href="bill.php"style="text-decoration:none";><input type="submit" name="submit"value="Pay Now"  class="btn"></a></form>
                    </form>
