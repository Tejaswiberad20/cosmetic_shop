...
<body>
    ...
    <div class="order-box">
        <div class="pinfo">
            ...
            <div>
                <h4 class="pname"><b><?php echo $productname; ?></b></h4>
                <ul type="circle" class="info">
                    <li><?php echo $productdesc; ?></li>
                </ul>
                <p class="price"><b>Rs.<?php echo $price; ?></b></p>
                <div class="qty">
                    <img src="../imges/plus.png" alt="Increase quantity" class="qimg" onclick="changeQuantity(1)" style="height:30px;">
                    <span style="font-size:25px;" id="quantity-text">1</span>
                    <img src="../imges/minus.png" alt="Decrease quantity" class="qimg" onclick="changeQuantity(-1)" style="height:30px;">&nbsp;
                </div>
                <p class="quantity-total" id="show-quantity">Quantity: 1</p>
                <h2 class="price" style="margin-top:30px;" id="show-total"><b>Total: Rs.<?php echo $price; ?>/-</b></h2>
            </div>
        </div>
        <a href="payment.php" class="link"><button type="button" class="btn">Next</button></a>
    </div>
    ...
    <script>
        function changeQuantity(amount) {
            ...
            showQuantity.innerText = `Quantity: ${quantity}`;
            showTotal.innerText = `Total: Rs.${quantity * <?php echo $price; ?>}/-`;
        }
    </script>
</body>
...
<body>
    ...
    <input type="text"name="mobno"value=""class="input"> 
    ...
    <input type="text"name="address"value=""class="input"> 
        <h3 class="text">Product Name</h3>
                ...
                <input type="text"value="<?php echo $price; ?>"class="input"id="price">
...
if (isset($_POST['submit']))
{
    ...
    $totprice=$_POST["totprice"];
      ...
      $sql = "INSERT INTO productorder(`username`,`mobno`,`address`,`productname`, `totprice`,`qauntity`) VALUES ('$username','$mobno','$address','$productname', '$totprice','$qauntity')";
