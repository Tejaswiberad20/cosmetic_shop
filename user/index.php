...
<body>
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
                            <a class="nav-link " href="./pages/feedback.php">FeedBack
                            </a>
                        </li>
          </ul>
  ...
  <div class="Category-card">
    <div class="catimg">
      <a href="./pages/face.php"><img src="./imges/face0.jpg" class="Category-img"></a>
      <h3 class="Category">Face</h3>
    </div>

    <div class="catimg">
    <a href="./pages/lip.php"><img src="./imges/lips.jpg" class="Category-img"></a>
      <h3 class="Category">Lips</h3>
    </div>
    <div class="catimg">
    <a href="./pages/eye.php"><img src="./imges/eye0.jpg" class="Category-img"></a>
      <h3 class="Category">Eye</h3>
    </div>
    <div class="catimg">
    <a href="./pages/nails.php"><img src="./imges/nail0.webp" class="Category-img"></a>
